package SGN::ExpressionViewer::Analyzer;
use Moose;
use SGN::ExpressionViewer::Converter;
...
has 'converter' => (isa => 'SGN::ExpressionViewer::Converter', 
						is => 'rw', lazy_build => 1);
has 'compare_converter' => (isa => 'SGN::ExpressionViewer::Converter',
 				is => 'rw', lazy_build => 1); 
has 'colorer' => (isa => 'SGN::ExpressionViewer::Colorer', 
		     			        is => 'ro', lazy_build => 1);
...
sub _build_converter
{
   ...
   my ($e_data_ref, $c_data_ref) =
		$self->_parse_data_from_data_ref($data_ref);
   my $converter = SGN::ExpressionViewer::Converter->new(
...
{
   my $self = shift;
   SGN::ExpressionViewer::Colorer->new(
